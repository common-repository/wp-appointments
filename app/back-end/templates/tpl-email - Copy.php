                                        ...
                                        <table id="footer" width="490" border="0" cellpadding="0" bgcolor="#ffffff" cellspacing="0" style="line-height:1.5;font-size:12px;font-family: Arial, sans-serif;margin-right:30px;margin-left:30px;">
                                            <tr style="font-size:11px;color:#999999;">
                                                <td style="border-top: solid 1px #d9d9d9;" colspan="2">
                                                    <div style="padding-top:15px; padding-bottom:1px;"><img height="13" width="13" style="vertical-align: middle;" src="<?php echo admin_url('images/date-button.gif') ?>" alt="<?php echo esc_attr__('Date', sahill) ?>"  /> <?php echo esc_attr__('Email sent', sahill) ?> %date% @ %time%</div>
                                                    <div><img height="12" width="12" style="vertical-align: middle;" src="<?php echo admin_url('images/comment-grey-bubble.png') ?>'" alt="<?php echo esc_attr__('Contact', sahill) ?>"  /> <?php _e('For any requests, please contact', sahill) ?> <a href="mailto:%admin_email%">%admin_email%</a></div>
                                                </td>
                                            </tr>
                                            <tr>
